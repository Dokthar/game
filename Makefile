...
LIB_DIRS := font geometry light loader material math mesh render scene shader texture util
#CFLAGS += $(foreach dir, $(LIB_DIRS), -Isrc/$(dir))
LIB_SOURCES := $(foreach dir, $(LIB_DIRS), $(wildcard src/$(dir)/*.c))
